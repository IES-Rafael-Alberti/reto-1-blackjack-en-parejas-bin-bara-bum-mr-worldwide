...
def jugar_black_Jack():
    ...
    from src.dar_carta import obtener_carta
    ...
    try:
        ...
        option_player =int(input("Opcion -> "))
        ...
        #Iniciamos la partida repartiendo dos cartas por jugador. 
            #Mano jugador 1
        cartas_jugador1 = ""
        mano_inicial_j1 = mano_inicial(jugador_1)
        otra_carta_j1 = obtener_carta()
        
        #LISTA DE LAS CARTAS
        cartas_jugador1 = str(cartas_jugador1) + str(mano_inicial_j1) + str(otra_carta_j1)
        #PUNTUACION QUE SUMAN LAS CARTAS
        print(total_puntos(cartas_jugador1))
        print(cartas_jugador1)

        #Mano jugador 2
        cartas_jugador2 = ""
        mano_inicial_j2 = mano_inicial(jugador_2)
        otra_carta_j2 = obtener_carta()
        
        #LISTA DE LAS CARTAS
        cartas_jugador2 = str(cartas_jugador2) + str(mano_inicial_j2) + str(otra_carta_j2)
        #PUNTUACION QUE SUMAN LAS CARTAS
        print(total_puntos(cartas_jugador2))
        print(cartas_jugador2)
